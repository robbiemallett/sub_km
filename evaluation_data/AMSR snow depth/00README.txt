...
DATA ORGANIZATION
The data files are available on NSIDC's FTP site:

ftp://sidads.colorado.edu/pub/DATASETS/AVDM/data/cryosphere/AMSRIce03/ground_data/snowdepth/
...
to a directory name in the FTP get command. 

For example, using a command-line FTP program, you can download all of 
the snow depth data files using the following commands:

%ftp sidads.colorado.edu (login as anonymous, and use your e-mail address as 
password)
ftp> cd /pub/DATASETS/AVDM/data/cryosphere/AMSRIce03/ground_data/
    
        
ftp> get snowdepth.tar

This command will generate a tar file on your local disk containing
everything under the subdirectory snowdepth.
...
FTP address. For example, to download all the snowdepth data, 
enter the following FTP address in your browser's location/address field:

ftp://sidads.colorado.edu/pub/DATASETS/AVDM/data/cryosphere/AMSRIce03/ground_data/snowdepth.tar
...
http://nsidc.org/data/nsidc-0424.html
...
Identify yourself as a user of "AMSRIce03 Snow Depth Data
(NSIDC-0424)." 
